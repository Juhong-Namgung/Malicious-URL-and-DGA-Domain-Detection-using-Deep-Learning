...
with tf.device("/GPU:0"):
    ...
    def conv_fully(max_len=80, emb_dim=32, max_vocab_len=39, W_reg=regularizers.l2(1e-4)):
        ...
        # 마지막 클래스 결정하는 layer
        output = Dense(4, activation='softmax', name='main_output')(hidden3)
