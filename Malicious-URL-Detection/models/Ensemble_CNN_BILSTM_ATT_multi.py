...
from keras.layers import Input, ELU, BatchNormalization, Convolution1D, MaxPooling1D, concatenate
...
with tf.device("/GPU:0"):
    ...
    def cnn_bilstm_att(max_len=80, emb_dim=32, max_vocab_len=128, W_reg=regularizers.l2(1e-4)):
...
with tf.device("/GPU:0"):
    ...
    # Experimental result
    Evaluator.calculate_measure_multi(best_model, x_test, y_test)
